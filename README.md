...
This repository includes complete source code, user manual, and test data. For reference, a copy of the user manual is available from this GitHub link: [DaTeR user manual](https://github.com/Bansal-CompBioLab/DaTeR/blob/main/DaTeR_Manual.pdf) 
